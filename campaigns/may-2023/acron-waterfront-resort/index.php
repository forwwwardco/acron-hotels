...
header("location: https://acronhotelsgoa.com/campaigns/monsoon-deal-2023/acron-waterfront-resort/index.php?type=".$type);
exit();
...
$SOURCE_ARR = array("0"=>"May Offer 2023(AWR)", "HTML"=>"Mailer | May Offer 2023(AWR)", "tripadvisor"=>"Tripadvisor | May Offer 2023(AWR)", "website"=>"Website | May Offer 2023(AWR)", "website_widget"=>"Website Widget | May Offer 2023(AWR)", "SMS"=>"SMS | May Offer 2023(AWR)", "facebook_comment"=>"Facebook Comment | May Offer 2023(AWR)", "facebook_ads"=>"Facebook Ads | May Offer 2023(AWR)", "facebook_post"=>"Facebook Post | May Offer 2023(AWR)", "instagram"=>"Instagram | May Offer 2023(AWR)", "youtube"=>"Youtube | May Offer 2023(AWR)", "facebook_ads_acr_interest"=>"(ACR) FB-Interest | May Offer 2023(AWR)", "facebook_ads_awr_interest"=>"(AWR) FB-Interest | May Offer 2023(AWR)", "facebook_ads_awr_demographic"=>"(AWR) FB-Demographic | May Offer 2023(AWR)", "facebook_ads_acr_demographic"=>"(ACR) FB-Demographic | May Offer 2023(AWR)", "awr_website_widget"=>"AWR Website Widget | May Offer 2023(AWR)", "asr_website_widget"=>"ASR Website Widget | May Offer 2023(AWR)", "acr_website_widget"=>"ACR Website Widget | May Offer 2023(AWR)", "acr_website"=>"ACR Website | May Offer 2023(AWR)", "facebook_ads_awr_lookalike"=>"(AWR) FB-Lookalike | May Offer 2023(AWR)", "facebook_ads_acr_lookalike"=>"(ACR) FB-Lookalike | May Offer 2023(AWR)", "facebook_stage_2"=>"Facebook Lead Ads - (Stage 2)", "whatsapp"=>"Gupshup WhatsApp | May Offer 2023(AWR)", "awr_website"=>"AWR Website | May Offer 2023(AWR)", "asr_website"=>"ASR Website | May Offer 2023(AWR)", "linkedin"=>"Linkedin | May Offer 2023(AWR)", "fb_stage_2_interest"=>"Facebook Lead Ads - (Stage 2)", "facebook_ads_asr_interest"=>"(ASR) FB-Interest | May Offer 2023(AWR)", "google_display_awr"=>"GDN(AWR) | May Offer 2023(AWR)", "google_display_acr"=>"GDN(ACR) | May Offer 2023(AWR)", "google_display_max_awr"=>"HOTELS - AWR | GDN Performance Max", "google_video_acr"=>"Google Video Campaign | ACR", "google_video_awr"=>"Google Video Campaign | AWR", "google_discovery_asr"=>"Google Discovery Campaign(ASR) | May Offer 2023(AWR)", "google_discovery_acr"=>"Google Discovery Campaign(ACR) | May Offer 2023(AWR)", "google_discovery_awr"=>"Google Discovery Campaign(AWR) | May Offer 2023(AWR)");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Acron Waterfront Resort | Acron Group of Hotels | Book Directly With Us</title>
  <META NAME="title" CONTENT="Acron Waterfront Resort | Acron Group of Hotels | Book Directly With Us" />
  ...
  <link rel="canonical" href="https://acronhotelsgoa.com/campaigns/may-2023/acron-waterfront-resort/index.php" />
  <meta property="og:title" content="Summer Offer! At Acron Waterfront Resort" />
  ...
  <!-- <meta property="og:image" content="https://acronhotelsgoa.com/campaigns/summer-offer-2023/assets/images/facebook.jpg" /> -->
  <!-- Bootastrap CSS -->
...
<body>
  ...
  <header id="header" class="header fixed-top"> <!-- Remove top padding for the header and on scroll --> 
    <div class="container-fluid text-center top-banner-bar">
  	 <p style="color:yellow;"><b>To Book Directly, Call: <a href="tel:+917722016888">+91 7722 016 888</a> / <a href="tel:+918799901617">+91 8799 901 617</a></b></p>
    </div>
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">

      <a href="index.php" class="logo d-flex align-items-center">
        <img src="assets/images/acron-waterfront-resort-logo.png" alt="Acron Group of Hotels">
        <!-- <span>FlexStart</span> -->
      </a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="btn btn-lg btn-info mx-3" href="tel:+917722016888"><span class="fa fa-phone-alt"></span>&nbsp;Call Now!</a></li>
        </ul>
      ...
      <div class="col-lg-8 d-flex flex-column justify-content-center">
        <main id="main">
          ...
          <section id="features" class="features px-4">
            ...
            <img src="assets/images/awr-offer.webp" class="img-fluid" alt="">
            ...
            <img src="assets/images/awr-inclusions-2.webp" class="img-fluid" alt="">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="row d-flex align-items-center">
                            <div class="col-md-6">
                              <p><img src="assets/images/acron-waterfront-resort/close-to-the-beach.svg" width="20px"> Close to Baga Beach</p>
                            </div>
                            <div class="col-md-6">
                              <p><img src="assets/images/acron-waterfront-resort/airport.svg" width="20px"> 30.3km from Mopa Airport</p>
                            </div>
                            <div class="col-md-6">
          ...
          <section id="portfolio" class="portfolio">
            ...
            <div class="container" data-aos="fade-up">
              ...
              <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-waterfront">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-waterfront">
                  <div class="portfolio-wrap">
                    <img src="assets/images/gallery/24.webp" class="img-fluid" alt="">
                    <div class="portfolio-info">
                      <div class="portfolio-links">
                        <a href="assets/images/gallery/24.webp" data-gallery="portfolioGallery" class="portfokio-lightbox"><i class="fas fa-plus"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body contact text-center">
          <img src="assets/images/acron-waterfront-resort-logo.png" width="125px" alt="Acron Waterfront Resort"><br><br>
