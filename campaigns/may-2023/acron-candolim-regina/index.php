...
header("location: https://acronhotelsgoa.com/campaigns/monsoon-deal-2023/acron-candolim-regina/index.php?type=".$type);
exit();
...
$SOURCE_ARR = array("0"=>"May Offer 2023(ACR)", "HTML"=>"Mailer | May Offer 2023(ACR)", "tripadvisor"=>"Tripadvisor | May Offer 2023(ACR)", "website"=>"Website | May Offer 2023(ACR)", "website_widget"=>"Website Widget | May Offer 2023(ACR)", "SMS"=>"SMS | May Offer 2023(ACR)", "facebook_comment"=>"Facebook Comment | May Offer 2023(ACR)", "facebook_ads"=>"Facebook Ads | May Offer 2023(ACR)", "facebook_post"=>"Facebook Post | May Offer 2023(ACR)", "instagram"=>"Instagram | May Offer 2023(ACR)", "youtube"=>"Youtube | May Offer 2023(ACR)", "facebook_ads_acr_interest"=>"(ACR) FB-Interest | May Offer 2023(ACR)", "facebook_ads_awr_interest"=>"(AWR) FB-Interest | May Offer 2023(ACR)", "facebook_ads_awr_demographic"=>"(AWR) FB-Demographic | May Offer 2023(ACR)", "facebook_ads_acr_demographic"=>"(ACR) FB-Demographic | May Offer 2023(ACR)", "awr_website_widget"=>"AWR Website Widget | May Offer 2023(ACR)", "asr_website_widget"=>"ASR Website Widget | May Offer 2023(ACR)", "acr_website_widget"=>"ACR Website Widget | May Offer 2023(ACR)", "acr_website"=>"ACR Website | May Offer 2023(ACR)", "facebook_ads_awr_lookalike"=>"(AWR) FB-Lookalike | May Offer 2023(ACR)", "facebook_ads_acr_lookalike"=>"(ACR) FB-Lookalike | May Offer 2023(ACR)", "facebook_stage_2"=>"Facebook Lead Ads - (Stage 2)", "whatsapp"=>"Gupshup WhatsApp | May Offer 2023(ACR)", "awr_website"=>"AWR Website | May Offer 2023(ACR)", "asr_website"=>"ASR Website | May Offer 2023(ACR)", "linkedin"=>"Linkedin | May Offer 2023(ACR)", "fb_stage_2_interest"=>"Facebook Lead Ads - (Stage 2)", "facebook_ads_asr_interest"=>"(ASR) FB-Interest | May Offer 2023(ACR)", "google_display_awr"=>"GDN(AWR) | May Offer 2023(ACR)", "google_display_acr"=>"GDN(ACR) | May Offer 2023(ACR)", "google_display_max_awr"=>"HOTELS - AWR | GDN Performance Max", "google_video_acr"=>"Google Video Campaign | ACR", "google_video_awr"=>"Google Video Campaign | AWR", "google_discovery_asr"=>"Google Discovery Campaign(ASR) | May Offer 2023(ACR)", "google_discovery_acr"=>"Google Discovery Campaign(ACR) | May Offer 2023(ACR)", "google_discovery_awr"=>"Google Discovery Campaign(AWR) | May Offer 2023(ACR)");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link rel="canonical" href="https://acronhotelsgoa.com/campaigns/may-2023/acron-candolim-regina/index.php" />
  <meta property="og:title" content="Summer Offer! At Acron Candolim Regina" />
  ...
  <!-- <meta property="og:image" content="https://acronhotelsgoa.com/campaigns/acron-candolim-regina/assets/images/facebook.jpg" /> -->
  <!-- Bootastrap CSS -->
      ...
      <div class="col-lg-8 d-flex flex-column justify-content-center">
        <main id="main">
          ...
          <section id="features" class="features px-4">
            ...
            <img src="assets/images/acr-inclusions-2.webp" class="img-fluid" alt="">
          ...
          <section id="portfolio" class="portfolio">
            ...
            <div class="container" data-aos="fade-up">
              ...
              <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-regina">
                  <div class="portfolio-wrap">
                    <img src="assets/images/gallery/34.webp" class="img-fluid" alt="">
                    <div class="portfolio-info">
                      <div class="portfolio-links">
