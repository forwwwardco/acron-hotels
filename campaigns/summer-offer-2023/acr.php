...
header("location: https://acronhotelsgoa.com/campaigns/may-2023/acron-candolim-regina/index.php?type=".$type);
exit();
...
$SOURCE_ARR = array("0"=>"Summer Offer 2023", "HTML"=>"Mailer | Summer Offer 2023", "tripadvisor"=>"Tripadvisor | Summer Offer 2023", "website"=>"Website | Summer Offer 2023", "website_widget"=>"Website Widget | Summer Offer 2023", "SMS"=>"SMS | Summer Offer 2023", "facebook_comment"=>"Facebook Comment | Summer Offer 2023", "facebook_ads"=>"Facebook Ads | Summer Offer 2023", "facebook_post"=>"Facebook Post | Summer Offer 2023", "instagram"=>"Instagram | Summer Offer 2023", "youtube"=>"Youtube | Summer Offer 2023", "facebook_ads_acr_interest"=>"(ACR) FB-Interest | Summer Offer 2023", "facebook_ads_awr_interest"=>"(AWR) FB-Interest | Summer Offer 2023", "facebook_ads_awr_demographic"=>"(AWR) FB-Demographic | Summer Offer 2023", "facebook_ads_acr_demographic"=>"(ACR) FB-Demographic | Summer Offer 2023", "awr_website_widget"=>"AWR Website Widget | Summer Offer 2023", "asr_website_widget"=>"ASR Website Widget | Summer Offer 2023", "acr_website_widget"=>"ACR Website Widget | Summer Offer 2023", "acr_website"=>"ACR Website | Summer Offer 2023", "facebook_ads_awr_lookalike"=>"(AWR) FB-Lookalike | Summer Offer 2023", "facebook_ads_acr_lookalike"=>"(ACR) FB-Lookalike | Summer Offer 2023", "facebook_stage_2"=>"Facebook Lead Ads - (Stage 2)", "whatsapp"=>"Gupshup WhatsApp | Summer Offer 2023", "awr_website"=>"AWR Website | Summer Offer 2023", "asr_website"=>"ASR Website | Summer Offer 2023", "linkedin"=>"Linkedin | Summer Offer 2023", "fb_stage_2_interest"=>"Facebook Lead Ads - (Stage 2)", "facebook_ads_asr_interest"=>"(ASR) FB-Interest | Summer Offer 2023", "google_display_awr"=>"GDN(AWR) | Summer Offer 2023", "google_display_acr"=>"GDN(ACR) | Summer Offer 2023", "google_display_max_awr"=>"HOTELS - AWR | GDN Performance Max", "google_video_acr"=>"Google Video Campaign | ACR", "google_video_awr"=>"Google Video Campaign | AWR", "google_discovery_asr"=>"Google Discovery Campaign(ASR) | Summer Offer 2023", "google_discovery_acr"=>"Google Discovery Campaign(ACR) | Summer Offer 2023", "google_discovery_awr"=>"Google Discovery Campaign(AWR) | Summer Offer 2023");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link rel="canonical" href="https://acronhotelsgoa.com/campaigns/summer-offer-2023/index.php" />
  <meta property="og:title" content="Summer Offer! At Acron Group of Hotels" />
...
<body>
  ...
  <div class="container-fluid text-center top-banner-bar">
	 <p><b>To Book Directly, Call: <a href="tel:+918888848038">+91 888 884 8038</a> / <a href="tel:+918799901615">+91 879 990 1615</a></b></p>
  </div>
      ...
      <div class="row d-flex justify-content-between mt-2">
        ...
        <div class="col-lg-7 d-flex align-items-center hero-img" data-aos="zoom-out" data-aos-delay="200">
          <div class="ratio ratio-16x9">
        		<iframe id="videoplay" class="embed-responsive-item" src="https://www.youtube.com/embed/98Fg_QE8d44?rel=0&amp;controls=1&amp;showinfo=0&autoplay=1&cc_load_policy=1"></iframe>
      		</div>
        </div>
      </div>
    </div>
  ...
  <main id="main">
    ...
    <!-- ======= About Section ======= -->
    <section id="features" class="features px-1" style="background-color: #ECF7FD;">
      ...
      <header class="section-header" id="book-direct-advantages">
    ...
    <!-- ======= About Section ======= -->
    <section id="about" class="about" style="background-color: #0b3f59; padding: 10px 0;">
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0 d-flex justify-content-center">
          ...
          <div class="col-lg-4 d-flex align-items-center justify-content-around my-1" data-aos="fade-up" data-aos-delay="200">
            <a class="btn btn-lg btn-light" href="tel:+918888848038"><span class="fa fa-phone-alt"></span>&nbsp; +91 888 884 8038</a>
          </div>
...
<footer id="footer" class="footer">
  ...
  <div class="footer-top">
    <div class="container">
      ...
      <small>
      <ul>
        <li>Valid till 31st May 2023.</li>
