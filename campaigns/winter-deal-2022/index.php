...
header("location: https://acronhotelsgoa.com/campaigns/new-year-offer-2023/index.php?type=".$type);
exit();
...
$SOURCE_ARR = array("0"=>"Winter Deal 2022", "HTML"=>"Mailer | Winter Deal 2022", "tripadvisor"=>"Tripadvisor | Winter Deal 2022", "website"=>"Website | Winter Deal 2022", "website_widget"=>"Website Widget | Winter Deal 2022", "SMS"=>"SMS | Winter Deal 2022", "facebook_comment"=>"Facebook Comment | Winter Deal 2022", "facebook_ads"=>"Facebook Ads | Winter Deal 2022", "facebook_post"=>"Facebook Post | Winter Deal 2022", "instagram"=>"Instagram | Winter Deal 2022", "youtube"=>"Youtube | Winter Deal 2022", "facebook_ads_acr_interest"=>"(ACR) FB-Interest | Winter Deal 2022", "facebook_ads_awr_interest"=>"(AWR) FB-Interest | Winter Deal 2022", "facebook_ads_awr_demographic"=>"(AWR) FB-Demographic | Winter Deal 2022", "facebook_ads_acr_demographic"=>"(ACR) FB-Demographic | Winter Deal 2022", "awr_website_widget"=>"AWR Website Widget | Winter Deal 2022", "asr_website_widget"=>"ASR Website Widget | Winter Deal 2022", "acr_website_widget"=>"ACR Website Widget | Winter Deal 2022", "acr_website"=>"ACR Website | Winter Deal 2022", "facebook_ads_awr_lookalike"=>"(AWR) FB-Lookalike | Winter Deal 2022", "facebook_ads_acr_lookalike"=>"(ACR) FB-Lookalike | Winter Deal 2022", "facebook_stage_2"=>"Facebook Lead Ads - (Stage 2)", "whatsapp"=>"WhatsApp | Winter Deal 2022", "awr_website"=>"AWR Website | Winter Deal 2022", "asr_website"=>"ASR Website | Winter Deal 2022", "linkedin"=>"Linkedin | Winter Deal 2022", "fb_stage_2_interest"=>"Facebook Lead Ads - (Stage 2)", "facebook_ads_asr_interest"=>"(ASR) FB-Interest | Winter Deal 2022", "google_display_max"=>"HOTELS - ACR | GDN Performance Max", "google_display_awr"=>"GDN(AWR) | Winter Deal 2022", "google_display_acr"=>"GDN(ACR) | Winter Deal 2022", "google_display_max_awr"=>"HOTELS - AWR | GDN Performance Max", "google_video_acr"=>"Google Video Campaign | ACR", "google_video_awr"=>"Google Video Campaign | AWR", "google_discovery_asr"=>"Google Discovery Campaign(ASR) | Winter Deal 2022", "google_discovery_acr"=>"Google Discovery Campaign(ACR) | Winter Deal 2022");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link rel="canonical" href="https://acronhotelsgoa.com/campaigns/winter-deal-2022/index.php" />
  <!-- Bootastrap CSS -->
...
<body>
  ...
  <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
    ...
    <nav id="navbar" class="navbar">
      <ul>
        ...
        <li><a class="nav-link scrollto" href="#features">Winter Offer</a></li>
      ...
      <div class="row d-flex justify-content-between">
        ...
        <div class="col-lg-7 d-flex align-items-center hero-img" data-aos="zoom-out" data-aos-delay="200">
          <div class="ratio ratio-16x9">
        		<iframe id="videoplay" class="embed-responsive-item" src="https://www.youtube.com/embed/QqEy_miDdfU?rel=0&amp;controls=1&amp;showinfo=0&autoplay=1&cc_load_policy=1"></iframe>
      		</div>
        </div>
      </div>
    </div>
  ...
  <main id="main">
    ...
    <!-- ======= About Section ======= -->
    <section id="features" class="features px-1" style="background-color: #def2f175;">
            ...
            <div class="content text-center">
              <div class="row">
                <div class="col-lg-4 p-2">
                  <img src="assets/images/acron-seaway-resort-winter-deal.webp" alt="Acron Seaway Resort Winter Deal" class="img-fluid">
                </div>
                <div class="col-lg-4 p-2">
                  <img src="assets/images/acron-candolim-regina-winter-deal.webp" alt="Acron Candolim Regina Winter Deal" class="img-fluid">
                </div>
                <div class="col-lg-4 p-2">
                  <img src="assets/images/acron-waterfront-resort-winter-deal.webp" alt="Acron Waterfront Resort Winter Deal" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
...
<footer id="footer" class="footer">
  ...
  <div class="footer-top">
    <div class="container">
      ...
      <small>
      <ul>
        <li>Valid till 31st Dec 2022.</li>
