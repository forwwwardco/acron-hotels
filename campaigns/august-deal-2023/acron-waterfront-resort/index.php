...
header("location: https://acronhotelsgoa.com/campaigns/winter-deal-2023/acron-waterfront-resort/index.php?type=".$type);
exit();
...
$SOURCE_ARR = array("0"=>"August Deal 2023(AWR)", "HTML"=>"Mailer | August Deal 2023(AWR)", "tripadvisor"=>"Tripadvisor | August Deal 2023(AWR)", "website"=>"Website | August Deal 2023(AWR)", "website_widget"=>"Website Widget | August Deal 2023(AWR)", "SMS"=>"SMS | August Deal 2023(AWR)", "facebook_comment"=>"Facebook Comment | August Deal 2023(AWR)", "facebook_ads"=>"Facebook Ads | August Deal 2023(AWR)", "facebook_post"=>"Facebook Post | August Deal 2023(AWR)", "instagram"=>"Instagram | August Deal 2023(AWR)", "youtube"=>"Youtube | August Deal 2023(AWR)", "facebook_ads_acr_interest"=>"(ACR) FB-Interest | August Deal 2023(AWR)", "facebook_ads_awr_interest"=>"(AWR) FB-Interest | August Deal 2023(AWR)", "facebook_ads_awr_demographic"=>"(AWR) FB-Demographic | August Deal 2023(AWR)", "facebook_ads_acr_demographic"=>"(ACR) FB-Demographic | August Deal 2023(AWR)", "awr_website_widget"=>"AWR Website Widget | August Deal 2023(AWR)", "asr_website_widget"=>"ASR Website Widget | August Deal 2023(AWR)", "acr_website_widget"=>"ACR Website Widget | August Deal 2023(AWR)", "acr_website"=>"ACR Website | August Deal 2023(AWR)", "facebook_ads_awr_lookalike"=>"(AWR) FB-Lookalike | August Deal 2023(AWR)", "facebook_ads_acr_lookalike"=>"(ACR) FB-Lookalike | August Deal 2023(AWR)", "facebook_stage_2"=>"Facebook Lead Ads - (Stage 2)", "whatsapp"=>"Gupshup WhatsApp | August Deal 2023(AWR)", "awr_website"=>"AWR Website | August Deal 2023(AWR)", "asr_website"=>"ASR Website | August Deal 2023(AWR)", "linkedin"=>"Linkedin | August Deal 2023(AWR)", "fb_stage_2_interest"=>"Facebook Lead Ads - (Stage 2)", "facebook_ads_asr_interest"=>"(ASR) FB-Interest | August Deal 2023(AWR)", "google_display_awr"=>"GDN(AWR) | August Deal 2023(AWR)", "google_display_acr"=>"GDN(ACR) | August Deal 2023(AWR)", "google_display_max_awr"=>"HOTELS - AWR | GDN Performance Max", "google_video_acr"=>"Google Video Campaign | ACR", "google_video_awr"=>"Google Video Campaign | AWR", "google_discovery_asr"=>"Google Discovery Campaign(ASR) | August Deal 2023(AWR)", "google_discovery_acr"=>"Google Discovery Campaign(ACR) | August Deal 2023(AWR)", "google_discovery_awr"=>"Google Discovery Campaign(AWR) | August Deal 2023(AWR)");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link rel="canonical" href="https://acronhotelsgoa.com/campaigns/august-deal-2023/acron-waterfront-resort/index.php" />
  <meta property="og:title" content="Exclusive Offer! At Acron Waterfront Resort" />
  ...
  <!-- <meta property="og:image" content="https://acronhotelsgoa.com/campaigns/august-deal-2023/assets/images/facebook.jpg" /> -->
  <!-- Bootastrap CSS -->
