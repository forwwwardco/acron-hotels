...
header("location: https://acronhotelsgoa.com/campaigns/winter-deal-2023/acron-seaway-resort/index.php?type=".$type);
exit();
...
$SOURCE_ARR = array("0"=>"August Deal 2023(ASR)", "HTML"=>"Mailer | August Deal 2023(ASR)", "tripadvisor"=>"Tripadvisor | August Deal 2023(ASR)", "website"=>"Website | August Deal 2023(ASR)", "website_widget"=>"Website Widget | August Deal 2023(ASR)", "SMS"=>"SMS | August Deal 2023(ASR)", "facebook_comment"=>"Facebook Comment | August Deal 2023(ASR)", "facebook_ads"=>"Facebook Ads | August Deal 2023(ASR)", "facebook_post"=>"Facebook Post | August Deal 2023(ASR)", "instagram"=>"Instagram | August Deal 2023(ASR)", "youtube"=>"Youtube | August Deal 2023(ASR)", "facebook_ads_acr_interest"=>"(ACR) FB-Interest | August Deal 2023(ASR)", "facebook_ads_awr_interest"=>"(AWR) FB-Interest | August Deal 2023(ASR)", "facebook_ads_awr_demographic"=>"(AWR) FB-Demographic | August Deal 2023(ASR)", "facebook_ads_acr_demographic"=>"(ACR) FB-Demographic | August Deal 2023(ASR)", "awr_website_widget"=>"AWR Website Widget | August Deal 2023(ASR)", "asr_website_widget"=>"ASR Website Widget | August Deal 2023(ASR)", "acr_website_widget"=>"ACR Website Widget | August Deal 2023(ASR)", "acr_website"=>"ACR Website | August Deal 2023(ASR)", "facebook_ads_awr_lookalike"=>"(AWR) FB-Lookalike | August Deal 2023(ASR)", "facebook_ads_acr_lookalike"=>"(ACR) FB-Lookalike | August Deal 2023(ASR)", "facebook_stage_2"=>"Facebook Lead Ads - (Stage 2)", "whatsapp"=>"Gupshup WhatsApp | August Deal 2023(ASR)", "awr_website"=>"AWR Website | August Deal 2023(ASR)", "asr_website"=>"ASR Website | August Deal 2023(ASR)", "linkedin"=>"Linkedin | August Deal 2023(ASR)", "fb_stage_2_interest"=>"Facebook Lead Ads - (Stage 2)", "facebook_ads_asr_interest"=>"(ASR) FB-Interest | August Deal 2023(ASR)", "google_display_awr"=>"GDN(AWR) | August Deal 2023(ASR)", "google_display_acr"=>"GDN(ACR) | August Deal 2023(ASR)", "google_display_max_awr"=>"HOTELS - AWR | GDN Performance Max", "google_video_acr"=>"Google Video Campaign | ACR", "google_video_awr"=>"Google Video Campaign | AWR", "google_discovery_asr"=>"Google Discovery Campaign(ASR) | August Deal 2023(ASR)", "google_discovery_acr"=>"Google Discovery Campaign(ACR) | August Deal 2023(ASR)", "google_discovery_awr"=>"Google Discovery Campaign(AWR) | August Deal 2023(ASR)");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link rel="canonical" href="https://acronhotelsgoa.com/campaigns/august-deal-2023/acron-seaway-resort/index.php" />
  <meta property="og:title" content="Exclusive Offer! At Acron Seaway Resort" />
      ...
      <div class="col-lg-8 d-flex flex-column justify-content-center">
        <main id="main">
          ...
          <section id="features" class="features text-center px-2">
            ...
            <img src="assets/images/asr-inclusions.webp" class="img-fluid" alt="">
          ...
          <section id="portfolio" class="portfolio">
            ...
            <div class="container" data-aos="fade-up">
              ...
              <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-seaway">
                  <div class="portfolio-wrap">
                    <img src="../assets/images/gallery/35.webp" class="img-fluid" alt="Acron Seaway Resort">
                    <div class="portfolio-info">
                      <div class="portfolio-links">
