...
header("location: https://acronhotelsgoa.com/campaigns/august-deal-2023/acron-seaway-resort/index.php?type=".$type);
exit();
...
$SOURCE_ARR = array("0"=>"Monsoon Deal 2023(ASR)", "HTML"=>"Mailer | Monsoon Deal 2023(ASR)", "tripadvisor"=>"Tripadvisor | Monsoon Deal 2023(ASR)", "website"=>"Website | Monsoon Deal 2023(ASR)", "website_widget"=>"Website Widget | Monsoon Deal 2023(ASR)", "SMS"=>"SMS | Monsoon Deal 2023(ASR)", "facebook_comment"=>"Facebook Comment | Monsoon Deal 2023(ASR)", "facebook_ads"=>"Facebook Ads | Monsoon Deal 2023(ASR)", "facebook_post"=>"Facebook Post | Monsoon Deal 2023(ASR)", "instagram"=>"Instagram | Monsoon Deal 2023(ASR)", "youtube"=>"Youtube | Monsoon Deal 2023(ASR)", "facebook_ads_acr_interest"=>"(ACR) FB-Interest | Monsoon Deal 2023(ASR)", "facebook_ads_awr_interest"=>"(AWR) FB-Interest | Monsoon Deal 2023(ASR)", "facebook_ads_awr_demographic"=>"(AWR) FB-Demographic | Monsoon Deal 2023(ASR)", "facebook_ads_acr_demographic"=>"(ACR) FB-Demographic | Monsoon Deal 2023(ASR)", "awr_website_widget"=>"AWR Website Widget | Monsoon Deal 2023(ASR)", "asr_website_widget"=>"ASR Website Widget | Monsoon Deal 2023(ASR)", "acr_website_widget"=>"ACR Website Widget | Monsoon Deal 2023(ASR)", "acr_website"=>"ACR Website | Monsoon Deal 2023(ASR)", "facebook_ads_awr_lookalike"=>"(AWR) FB-Lookalike | Monsoon Deal 2023(ASR)", "facebook_ads_acr_lookalike"=>"(ACR) FB-Lookalike | Monsoon Deal 2023(ASR)", "facebook_stage_2"=>"Facebook Lead Ads - (Stage 2)", "whatsapp"=>"Gupshup WhatsApp | Monsoon Deal 2023(ASR)", "awr_website"=>"AWR Website | Monsoon Deal 2023(ASR)", "asr_website"=>"ASR Website | Monsoon Deal 2023(ASR)", "linkedin"=>"Linkedin | Monsoon Deal 2023(ASR)", "fb_stage_2_interest"=>"Facebook Lead Ads - (Stage 2)", "facebook_ads_asr_interest"=>"(ASR) FB-Interest | Monsoon Deal 2023(ASR)", "google_display_awr"=>"GDN(AWR) | Monsoon Deal 2023(ASR)", "google_display_acr"=>"GDN(ACR) | Monsoon Deal 2023(ASR)", "google_display_max_awr"=>"HOTELS - AWR | GDN Performance Max", "google_video_acr"=>"Google Video Campaign | ACR", "google_video_awr"=>"Google Video Campaign | AWR", "google_discovery_asr"=>"Google Discovery Campaign(ASR) | Monsoon Deal 2023(ASR)", "google_discovery_acr"=>"Google Discovery Campaign(ACR) | Monsoon Deal 2023(ASR)", "google_discovery_awr"=>"Google Discovery Campaign(AWR) | Monsoon Deal 2023(ASR)");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link rel="canonical" href="https://acronhotelsgoa.com/campaigns/monsoon-deal-2023/acron-seaway-resort/index.php" />
  <meta property="og:title" content="Monsoon Offer! At Acron Seaway Resort" />
