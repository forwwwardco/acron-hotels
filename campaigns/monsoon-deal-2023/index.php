...
header("location: https://acronhotelsgoa.com/campaigns/august-deal-2023/index.php?type=".$type);
exit();
...
$SOURCE_ARR = array("0"=>"Monsoon Deal 2023", "HTML"=>"Mailer | Monsoon Deal 2023", "tripadvisor"=>"Tripadvisor | Monsoon Deal 2023", "website"=>"Website | Monsoon Deal 2023", "website_widget"=>"Website Widget | Monsoon Deal 2023", "SMS"=>"SMS | Monsoon Deal 2023", "facebook_comment"=>"Facebook Comment | Monsoon Deal 2023", "facebook_ads"=>"Facebook Ads | Monsoon Deal 2023", "facebook_post"=>"Facebook Post | Monsoon Deal 2023", "instagram"=>"Instagram | Monsoon Deal 2023", "youtube"=>"Youtube | Monsoon Deal 2023", "facebook_ads_acr_interest"=>"(ACR) FB-Interest | Monsoon Deal 2023", "facebook_ads_awr_interest"=>"(AWR) FB-Interest | Monsoon Deal 2023", "facebook_ads_awr_demographic"=>"(AWR) FB-Demographic | Monsoon Deal 2023", "facebook_ads_acr_demographic"=>"(ACR) FB-Demographic | Monsoon Deal 2023", "awr_website_widget"=>"AWR Website Widget | Monsoon Deal 2023", "asr_website_widget"=>"ASR Website Widget | Monsoon Deal 2023", "acr_website_widget"=>"ACR Website Widget | Monsoon Deal 2023", "acr_website"=>"ACR Website | Monsoon Deal 2023", "facebook_ads_awr_lookalike"=>"(AWR) FB-Lookalike | Monsoon Deal 2023", "facebook_ads_acr_lookalike"=>"(ACR) FB-Lookalike | Monsoon Deal 2023", "facebook_stage_2"=>"Facebook Lead Ads - (Stage 2)", "whatsapp"=>"Gupshup WhatsApp | Monsoon Deal 2023", "awr_website"=>"AWR Website | Monsoon Deal 2023", "asr_website"=>"ASR Website | Monsoon Deal 2023", "linkedin"=>"Linkedin | Monsoon Deal 2023", "fb_stage_2_interest"=>"Facebook Lead Ads - (Stage 2)", "facebook_ads_asr_interest"=>"(ASR) FB-Interest | Monsoon Deal 2023", "google_display_awr"=>"GDN(AWR) | Monsoon Deal 2023", "google_display_acr"=>"GDN(ACR) | Monsoon Deal 2023", "google_display_max_awr"=>"HOTELS - AWR | GDN Performance Max", "google_video_acr"=>"Google Video Campaign | ACR", "google_video_awr"=>"Google Video Campaign | AWR", "google_discovery_asr"=>"Google Discovery Campaign(ASR) | Monsoon Deal 2023", "google_discovery_acr"=>"Google Discovery Campaign(ACR) | Monsoon Deal 2023", "google_discovery_awr"=>"Google Discovery Campaign(AWR) | Monsoon Deal 2023", "google_discovery"=>"Google Discovery Campaign | Monsoon Deal 2023", "html_chris"=>"Chris Mumbai Expo HTML");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link rel="canonical" href="https://acronhotelsgoa.com/campaigns/monsoon-deal-2023/index.php" />
  <meta property="og:title" content="Monsoon Offer! At Acron Group of Hotels" />
          ...
          <div class="col-lg-12 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content text-center">
              <div class="row">
                ...
                <div class="col-lg-4 p-2">
                  <img src="assets/images/acron-candolim-regina-monsoon-deal.jpg" alt="Acron Candolim Regina Monsoon Deal" class="img-fluid">
                </div>
                <div class="col-lg-4 p-2">
                  <img src="assets/images/acron-seaway-resort-monsoon-deal.jpg" alt="Acron Seaway Resort Monsoon Deal" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
