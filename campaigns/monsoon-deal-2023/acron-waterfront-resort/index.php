...
header("location: https://acronhotelsgoa.com/campaigns/august-deal-2023/acron-waterfront-resort/index.php?type=".$type);
exit();
...
$SOURCE_ARR = array("0"=>"Monsoon Deal 2023(AWR)", "HTML"=>"Mailer | Monsoon Deal 2023(AWR)", "tripadvisor"=>"Tripadvisor | Monsoon Deal 2023(AWR)", "website"=>"Website | Monsoon Deal 2023(AWR)", "website_widget"=>"Website Widget | Monsoon Deal 2023(AWR)", "SMS"=>"SMS | Monsoon Deal 2023(AWR)", "facebook_comment"=>"Facebook Comment | Monsoon Deal 2023(AWR)", "facebook_ads"=>"Facebook Ads | Monsoon Deal 2023(AWR)", "facebook_post"=>"Facebook Post | Monsoon Deal 2023(AWR)", "instagram"=>"Instagram | Monsoon Deal 2023(AWR)", "youtube"=>"Youtube | Monsoon Deal 2023(AWR)", "facebook_ads_acr_interest"=>"(ACR) FB-Interest | Monsoon Deal 2023(AWR)", "facebook_ads_awr_interest"=>"(AWR) FB-Interest | Monsoon Deal 2023(AWR)", "facebook_ads_awr_demographic"=>"(AWR) FB-Demographic | Monsoon Deal 2023(AWR)", "facebook_ads_acr_demographic"=>"(ACR) FB-Demographic | Monsoon Deal 2023(AWR)", "awr_website_widget"=>"AWR Website Widget | Monsoon Deal 2023(AWR)", "asr_website_widget"=>"ASR Website Widget | Monsoon Deal 2023(AWR)", "acr_website_widget"=>"ACR Website Widget | Monsoon Deal 2023(AWR)", "acr_website"=>"ACR Website | Monsoon Deal 2023(AWR)", "facebook_ads_awr_lookalike"=>"(AWR) FB-Lookalike | Monsoon Deal 2023(AWR)", "facebook_ads_acr_lookalike"=>"(ACR) FB-Lookalike | Monsoon Deal 2023(AWR)", "facebook_stage_2"=>"Facebook Lead Ads - (Stage 2)", "whatsapp"=>"Gupshup WhatsApp | Monsoon Deal 2023(AWR)", "awr_website"=>"AWR Website | Monsoon Deal 2023(AWR)", "asr_website"=>"ASR Website | Monsoon Deal 2023(AWR)", "linkedin"=>"Linkedin | Monsoon Deal 2023(AWR)", "fb_stage_2_interest"=>"Facebook Lead Ads - (Stage 2)", "facebook_ads_asr_interest"=>"(ASR) FB-Interest | Monsoon Deal 2023(AWR)", "google_display_awr"=>"GDN(AWR) | Monsoon Deal 2023(AWR)", "google_display_acr"=>"GDN(ACR) | Monsoon Deal 2023(AWR)", "google_display_max_awr"=>"HOTELS - AWR | GDN Performance Max", "google_video_acr"=>"Google Video Campaign | ACR", "google_video_awr"=>"Google Video Campaign | AWR", "google_discovery_asr"=>"Google Discovery Campaign(ASR) | Monsoon Deal 2023(AWR)", "google_discovery_acr"=>"Google Discovery Campaign(ACR) | Monsoon Deal 2023(AWR)", "google_discovery_awr"=>"Google Discovery Campaign(AWR) | Monsoon Deal 2023(AWR)");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link rel="canonical" href="https://acronhotelsgoa.com/campaigns/monsoon-deal-2023/acron-waterfront-resort/index.php" />
  <meta property="og:title" content="Monsoon Offer! At Acron Waterfront Resort" />
        ...
        <div class="col-lg-8 d-flex align-items-center hero-img" data-aos="zoom-out" data-aos-delay="200">
          <div class="ratio ratio-16x9">
            <iframe id="videoplay" class="embed-responsive-item" src="https://www.youtube.com/embed/6QOEGaR1DmI?rel=0&amp;controls=1&amp;showinfo=0&autoplay=1&cc_load_policy=1"></iframe>
        		<!-- <lite-youtube videoid="6QOEGaR1DmI" style="background-image: url('https://i.ytimg.com/vi/6QOEGaR1DmI/maxresdefault.jpg');">
      ...
      <div class="col-lg-8 d-flex flex-column justify-content-center">
        <main id="main">
          ...
          <section id="features" class="features text-center px-2">
            ...
            <img src="assets/images/awr-inclusions.webp" class="img-fluid" alt="">
          ...
          <section id="portfolio" class="portfolio">
            ...
            <div class="container" data-aos="fade-up">
              ...
              <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-waterfront">
                  <div class="portfolio-wrap">
                    <img src="../assets/images/gallery/24.webp" class="img-fluid" alt="Acron Waterfront Resort">
                    <div class="portfolio-info">
                      <div class="portfolio-links">
