...
// header("location: https://acronhotelsgoa.com/campaigns/winter-deal-2022/index.php?type=".$type);
// exit();
...
$SOURCE_ARR = array("0"=>"Monsoon Deal 2022", "HTML"=>"Mailer | Monsoon Deal 2022", "tripadvisor"=>"Tripadvisor | Monsoon Deal 2022", "website"=>"Website | Monsoon Deal 2022", "website_widget"=>"Website Widget | Monsoon Deal 2022", "SMS"=>"SMS | Monsoon Deal 2022", "facebook_comment"=>"Facebook Comment | Monsoon Deal 2022", "facebook_ads"=>"Facebook Ads | Monsoon Deal 2022", "facebook_post"=>"Facebook Post | Monsoon Deal 2022", "instagram"=>"Instagram | Monsoon Deal 2022", "youtube"=>"Youtube | Monsoon Deal 2022", "facebook_ads_acr_interest"=>"(ACR) FB-Interest | Monsoon Deal 2022", "facebook_ads_awr_interest"=>"(AWR) FB-Interest | Monsoon Deal 2022", "facebook_ads_awr_demographic"=>"(AWR) FB-Demographic | Monsoon Deal 2022", "facebook_ads_acr_demographic"=>"(ACR) FB-Demographic | Monsoon Deal 2022", "awr_website_widget"=>"AWR Website Widget | Monsoon Deal 2022", "asr_website_widget"=>"ASR Website Widget | Monsoon Deal 2022", "acr_website_widget"=>"ACR Website Widget | Monsoon Deal 2022", "acr_website"=>"ACR Website | Monsoon Deal 2022", "facebook_ads_awr_lookalike"=>"(AWR) FB-Lookalike | Monsoon Deal 2022", "facebook_ads_acr_lookalike"=>"(ACR) FB-Lookalike | Monsoon Deal 2022", "facebook_stage_2"=>"Facebook Lead Ads - (Stage 2)", "whatsapp"=>"WhatsApp Gupshup Campaign | Monsoon Deal 2022", "awr_website"=>"AWR Website | Monsoon Deal 2022", "asr_website"=>"ASR Website | Monsoon Deal 2022", "linkedin"=>"Linkedin | Monsoon Deal 2022", "fb_stage_2_interest"=>"Facebook Lead Ads - (Stage 2)", "facebook_ads_asr_interest"=>"(ASR) FB-Interest | Monsoon Deal 2022", "google_display_max"=>"HOTELS - ACR | GDN Performance Max", "google_display_awr"=>"GDN(AWR) | Monsoon Deal 2022", "google_display_acr"=>"GDN(ACR) | Monsoon Deal 2022", "google_display_max_awr"=>"HOTELS - AWR | GDN Performance Max", "google_video_acr"=>"Google Video Campaign | ACR", "google_video_awr"=>"Google Video Campaign | AWR", "google_discovery_asr"=>"Google Discovery Campaign | ASR", "google_discovery_acr"=>"Google Discovery Campaign | ACR");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Acron Group of Hotels | Book Directly With Us | Best Rate Guranteed</title>
  <meta name="title" content="Acron Group of Hotels | Book Directly With Us | Best Rate Guranteed" />
  ...
  <meta property="og:url" content="https://www.acronhotelsgoa.com/campaigns/monsoon-deal-2022/index.php?type=facebook_post" />
  <meta property="og:type" content="Website" />
  <meta property="og:title" content="Exciting Monsoon Hotel Deals in Goa" />
  <meta property="og:description" content="Book Directly With Us" />
  <meta property="og:image" content="https://acronhotelsgoa.com/campaigns/monsoon-deal-2022/assets/images/fb-offer-acr.jpg" />
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav color02">
                  ...
                  <li><a href="#deals">Monsoon Deal</a></li>
    	...
    	<div class="row">
			...
			<div class="col-md-6" >
	      		<div class="embed-responsive embed-responsive-16by9">
	        		<iframe id="videoplay" class="embed-responsive-item" src="https://www.youtube.com/embed/PmeEewr5zns?rel=0&amp;controls=1&amp;showinfo=0&autoplay=1&cc_load_policy=1"></iframe>
	      		</div>
	      	</div>	
	    ...
	    <div class="row">
		    <div class="col-md-12">
		        <section id="deals" class="text-center">
		        	<h2>Monsoon in Goa: Grab the best deals on luxury stays at <font color="#e31e23">#ACRONHOTELSGOA</font></h2><br>
  ...
  <br>
		  ...
		  <div class="container">
	            ...
	            <div class="row text-center">
	              ...
	              <div class="panel">
	              	<div class="panel-body">
	              		<div class="col-xs-4">
	              			<img class="profile-img lazyload" src="https://media-cdn.tripadvisor.com/media/photo-l/1a/f6/ec/a2/default-avatar-2020-3.jpg">
	              		</div>
	              		<div class="col-xs-8 text-left">
	              			<h5 class="text-left">Helen J</h5>
	              		...
	              		<div style="padding: 5px;" class="col-xs-12">
		              		<p class="text-left">It was really a dream vacation for me and my family... The property is uniquely positioned facing the Baga river and a glimse of the Baga beach</p>
		              		<div class="col-xs-2 text-center"><img src="assets/images/tripadvisor.webp" width="30"></div>
		              		<div class="col-xs-10"><h5 class="review-date text-muted text-left"><i>June 2022</i></h5></div>
	              		</div>
	              	</div>
	              </div>
	              <div class="panel">
	              	<div class="panel-body">
	              		<div class="col-xs-4">
	              			<img class="profile-img lazyload" src="https://lh3.googleusercontent.com/a-/AOh14Gi4LqFD6v-JlMCn7Z-Jm1nk-6TtrlHOXg7xhWaTpwE=w60-h60-p-rp-mo-ba3-br100">
	              		</div>
	              		<div class="col-xs-8 text-left">
	              			<h5 class="text-left">Himanshu Sao</h5>
	              			<span class="fa fa-star star-active ml-3"></span>
	              			<span class="fa fa-star star-active ml-3"></span>
	              			<span class="fa fa-star star-active ml-3"></span>
	              			<span class="fa fa-star star-active ml-3"></span>
	              		...
	              		<div style="padding: 5px;" class="col-xs-12">
		              		<p class="text-left">Best resort in terms of service and hospitality. If you’re staying in north goa than it’s the best choice.</p>
		              		<div class="col-xs-2 text-center"><img src="assets/images/google.webp" width="30"></div>
		              		<div class="col-xs-10"><h5 class="review-date text-muted text-left"><i>May 2022</i></h5></div>
	              		</div>
	              	</div>
	              </div>
	              <div class="panel">
	              	<div class="panel-body">
	              		<div class="col-xs-4">
	              			<img class="profile-img lazyload" src="https://media-cdn.tripadvisor.com/media/photo-l/1a/f6/ef/32/default-avatar-2020-12.jpg">
	              		</div>
	              		<div class="col-xs-8 text-left">
	              			<h5 class="text-left">Aziz</h5>
	              			<span class="fa fa-star star-active ml-3"></span>
	              			<span class="fa fa-star star-active ml-3"></span>
	              			<span class="fa fa-star star-active ml-3"></span>
	              			<span class="fa fa-star star-active ml-3"></span>
	              		...
	              		<div style="padding: 5px;" class="col-xs-12">
		              		<p class="text-left">Wonderful experience just few minutes walking distance from beach. Beautiful architecture great service. Helpful staff. Highly Recommended.</p>
		              		<div class="col-xs-2 text-center"><img src="assets/images/tripadvisor.webp" width="30"></div>
		              		<div class="col-xs-10"><h5 class="review-date text-muted text-left"><i>June 2022</i></h5></div>
	              		</div>
	              	</div>
	              ...
	              <div class="panel">
	              	<div class="panel-body">
	              		<div class="col-xs-4">
	              			<img class="profile-img lazyload" src="https://media-cdn.tripadvisor.com/media/photo-l/1a/f6/e4/a9/default-avatar-2020-50.jpg">
	              		</div>
	              		<div class="col-xs-8 text-left">
	              			<h5 class="text-left">Sherpa</h5>
	              			<span class="fa fa-star star-active ml-3"></span>
	              			<span class="fa fa-star star-active ml-3"></span>
	              			<span class="fa fa-star star-active ml-3"></span>
	              			<span class="fa fa-star star-active ml-3"></span>
	              		...
	              		<div style="padding: 5px;" class="col-xs-12">
		              		<p class="text-left">Staff was courteous and helpful. Every thing was great, food, cleanliness. Rooms were so spacious. Would love to visit and refer this hotel.</p>
		              		<div class="col-xs-2 text-center"><img src="assets/images/tripadvisor.webp" width="30"></div>
		              		<div class="col-xs-10"><h5 class="review-date text-muted text-left"><i>May 2022</i></h5></div>
	              		</div>
	              	</div>
	              ...
	              <div class="panel">
	              	<div class="panel-body">
	              		<div class="col-xs-4">
	              			<img class="profile-img lazyload" src="https://lh3.googleusercontent.com/a-/AOh14Ggs6hk4xKoLOupi4mj83DIICFcwEGpk-NLksGVgJO4=w60-h60-p-rp-mo-br100">
	              		</div>
	              		<div class="col-xs-8 text-left">
	              			<h5 class="text-left">Aprajita Rana</h5>
	              			<span class="fa fa-star star-active ml-3"></span>
	              			<span class="fa fa-star star-active ml-3"></span>
	              			<span class="fa fa-star star-active ml-3"></span>
	              			<span class="fa fa-star star-active ml-3"></span>
	              		...
	              		<div style="padding: 5px;" class="col-xs-12">
		              		<p class="text-left">Amazing place with lots of staff and beautiful ambience. Suite in particular was comfortable and well furnished. Had great time there.</p>
		              		<div class="col-xs-2 text-center"><img src="assets/images/google.webp" width="30"></div>
		              		<div class="col-xs-10"><h5 class="review-date text-muted text-left"><i>May 2022</i></h5></div>
	              		</div>
	              	</div>
	              ...
	              <div class="panel">
	              	<div class="panel-body">
	              		<div class="col-xs-4">
	              			<img class="profile-img lazyload" src="https://media-cdn.tripadvisor.com/media/photo-l/1a/f6/f4/d0/default-avatar-2020-33.jpg">
	              		</div>
	              		<div class="col-xs-8 text-left">
	              			<h5 class="text-left">Dhananjay</h5>
	              			<span class="fa fa-star star-active ml-3"></span>
	              			<span class="fa fa-star star-active ml-3"></span>
	              			<span class="fa fa-star star-active ml-3"></span>
	              			<span class="fa fa-star star-active ml-3"></span>
	              		...
	              		<div style="padding: 5px;" class="col-xs-12">
		              		<p class="text-left">Stay was good, food was amazing, staff was courteous and helpful. I love to visit again and refer the hotel. It was really home away from home.</p>
		              		<div class="col-xs-2 text-center"><img src="assets/images/tripadvisor.webp" width="30"></div>
		              		<div class="col-xs-10"><h5 class="review-date text-muted text-left"><i>June 2022</i></h5></div>
	              		</div>
	              	</div>
            ...
            <div class="divider"></div>
		        ...
		        <br>
			    <p><small>*Offer Valid till 31<sup>st</sup> August 2022 only. Minimum 3N/4D stay on twin sharing basis. Exclusive of taxes.</small></p>
		   	</div>
	    </div>   
	</div>
    <br>
