...
header("location: https://acronhotelsgoa.com/campaigns/winter-package-goa-2024/index.php?type=".$type); exit();
...
$SOURCE_ARR = array("0"=>"Monsoon Offer 2024", "HTML"=>"Mailer | Monsoon Offer 2024", "tripadvisor"=>"Tripadvisor | Monsoon Offer 2024", "website"=>"Website | Monsoon Offer 2024", "website_widget"=>"Website Widget | Monsoon Offer 2024", "SMS"=>"SMS | Monsoon Offer 2024", "facebook_comment"=>"Facebook Comment | Monsoon Offer 2024", "facebook_ads"=>"Facebook Ads | Monsoon Offer 2024", "facebook_post"=>"Facebook Post | Monsoon Offer 2024", "instagram"=>"Instagram | Monsoon Offer 2024", "youtube"=>"Youtube | Monsoon Offer 2024", "facebook_ads_acr_interest"=>"(ACR) FB-Interest | Monsoon Offer 2024", "facebook_ads_awr_interest"=>"(AWR) FB-Interest | Monsoon Offer 2024", "facebook_ads_awr_demographic"=>"(AWR) FB-Demographic | Monsoon Offer 2024", "facebook_ads_acr_demographic"=>"(ACR) FB-Demographic | Monsoon Offer 2024", "awr_website_widget"=>"AWR Website Widget | Monsoon Offer 2024", "asr_website_widget"=>"ASR Website Widget | Monsoon Offer 2024", "acr_website_widget"=>"ACR Website Widget | Monsoon Offer 2024", "acr_website"=>"ACR Website | Monsoon Offer 2024", "facebook_ads_awr_lookalike"=>"(AWR) FB-Lookalike | Monsoon Offer 2024", "facebook_ads_acr_lookalike"=>"(ACR) FB-Lookalike | Monsoon Offer 2024", "facebook_stage_2"=>"Facebook Lead Ads - (Stage 2)", "whatsapp"=>"Gupshup WhatsApp | Monsoon Offer 2024", "awr_website"=>"AWR Website | Monsoon Offer 2024", "asr_website"=>"ASR Website | Monsoon Offer 2024", "linkedin"=>"Linkedin | Monsoon Offer 2024", "fb_stage_2_interest"=>"Facebook Lead Ads - (Stage 2)", "facebook_ads_asr_interest"=>"(ASR) FB-Interest | Monsoon Offer 2024", "google_display_awr"=>"GDN(AWR) | Monsoon Offer 2024", "google_display_acr"=>"GDN(ACR) | Monsoon Offer 2024", "google_display_max_awr"=>"HOTELS - AWR | GDN Performance Max", "google_video_acr"=>"Google Video Campaign | ACR", "google_video_awr"=>"Google Video Campaign | AWR", "demand_gen_asr"=>"Google Demand Gen(ASR) | Monsoon Offer 2024", "demand_gen_acr"=>"Google Demand Gen(ACR) | Monsoon Offer 2024", "demand_gen"=>"Google Demand Gen | Monsoon Offer 2024");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Acron Group of Hotels in Goa | Book Directly With Us | Acron Hotels Monsson Package in Goa</title>
  <META NAME="title" CONTENT="Acron Group of Hotels in Goa | Book Directly With Us | Acron Hotels Monsson Package in Goa" />
  <meta name="description" content="Monsoon in Goa! The best time of the year to stay at a place as beautiful as Acron." />
  <meta name="keywords" content="boutique hotels in Goa, hotels near baga beach,luxury resort in baga, monsoon package, goa hotels, book direct, goa" />
  <META NAME="author" CONTENT="Acron Group of Hotels" />
  <META NAME="copyright" CONTENT="Acron Hospitality Pvt. Ltd." />
  <META NAME="robots" CONTENT="all" />
  <link rel="canonical" href="https://acronhotelsgoa.com/campaigns/Monsoon-offer-2024/index.php" />
  <meta property="og:title" content="Monsoon in Goa! The best time of the year to stay at a place as beautiful as Acron." />
  ...
  <!-- <meta property="og:image" content="https://acronhotelsgoa.com/campaigns/winter-deal-2023/assets/images/facebook.jpg" /> -->
  <!-- Bootastrap CSS -->
  ...
  <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
    ...
    <nav id="navbar" class="navbar">
      <ul>
        ...
        <li><a class="nav-link scrollto" href="#features">Monsoon Package</a></li>
        <li><a class="nav-link scrollto" href="#book-direct-advantages">Offer Inclusions</a></li>
      ...
      <div class="row d-flex justify-content-between mt-4">
        ...
        <div class="col-lg-8 d-flex align-items-center hero-img" data-aos="zoom-out" data-aos-delay="200">
          <div class="ratio ratio-16x9">
            <iframe id="videoplay" class="embed-responsive-item" src="https://www.youtube.com/embed/sT3B9BE6IOA?rel=0&amp;controls=1&amp;showinfo=0&autoplay=1&cc_load_policy=1"></iframe>
      		</div>
        </div>
      </div>
    </div>
  ...
  <main id="main">
    ...
    <section id="features" class="features px-1" style="background-color: #D2ECFB;">
      ...
      <header class="section-header">
        <p>MONSOON IN GOA!</p>
        <h4>The best time of the year to stay at a place as beautiful as Acron!</h4>
            ...
            <div class="content text-center">
              <div class="row">
                <div class="col-lg-4 p-2">
                  <img src="assets/images/acron-waterfront-resort-monsoon-deal.jpg" alt="Acron Waterfront Resort Monsoon Deal" class="img-fluid">
                </div>
                <div class="col-lg-4 p-2">
                  <img src="assets/images/acron-candolim-regina-monsoon-deal.jpg" alt="Acron Candolim Regina Monsoon Offer" class="img-fluid">
                </div>
                <div class="col-lg-4 p-2">
                  <img src="assets/images/acron-seaway-resort-monsoon-deal.jpg" alt="Acron Seaway Resort Monsoon Package" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
    ...
    <section id="book-direct-advantages" class="about px-1">
      ...
      <div class="container" data-aos="fade-up">
        <div class="row p-4 gx-0 d-flex justify-content-center text-center" style="color: #2b7d9e;">

          <div class="col-lg-2 p-4">
            <img src="assets/images/icons/buffet-breakfast.png" width="150px" alt="Buffet Breakfast" class="img-fluid">
            <h4><b>Buffet Breakfast</b></h4>
          </div>
          <div class="col-lg-2 p-4">
            <img src="assets/images/icons/buffet-dinner.png" width="150px" alt="Buffet Dinner" class="img-fluid">
            <h4><b>Buffet Dinner</b></h4>
          </div>
          <div class="col-lg-2 p-4">
            <img src="assets/images/icons/happy-hour.png" width="150px" alt="Happy Hour" class="img-fluid">
            <h4><b>Happy Hour</b></h4>
          </div>
          <div class="col-lg-2 p-4">
            <img src="assets/images/icons/high-tea.png" width="150px" alt="High Tea" class="img-fluid">
            <h4><b>High <br>Tea</b></h4>
          </div>
          <div class="col-lg-2 p-4">
            <img src="assets/images/icons/spa.png" width="150px" alt="Head & Foot Massage" class="img-fluid">
            <h4><b>500 Worth Spa Voucher</b></h4>
          </div>
          <div class="col-lg-2 p-4">
            <img src="assets/images/icons/discount.png" width="150px" alt="15% off on Food & Drinks" class="img-fluid">
            <h4><b>On Food & Drinks</b></h4>
          </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>My stay was superb and amazing. Really recommend this to everyone visiting north goa. Hospitality was top notch. The stay was really worthy. Room service at the top mark. In house food is just delicious. Staff is very helpfull and polite. The view is just mesmerizing. Room size and cleanliness was top notch. Also it was affordable.. a proper blend of luxury in budget.</p>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  Unique position on the Baga river by the sea. A perfect location for the Baga area, right on the river close to where it empties into the Sea. Comfortable clean rooms with balcony, we had lovely room overlooking the water and plenty of interest as we see the local fishermen working on their nets and boats. The restaurant has a wide choice on the menu of continental and Goan/Indian specialties and also for dinner. We did also spend time by the lovely pool which overlooks the river and the sea.
                </p>
                <div class="profile mt-auto">
                  <h3>Devesh</h3>
                </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  Great experience! I recently booked a 3-night stay for my parents at Acron Resort in Goa, and overall, it was a delightful experience. The resort provided a comfortable and enjoyable atmosphere, earning it a solid 5-star rating. My parents particularly raved about the delicious breakfast, which added a pleasant touch to their mornings. The attentive service and serene surroundings made their stay memorable.
                </p>
                <div class="profile mt-auto">
                  <h3>Sagar Rawlani</h3>
                </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  Acron Candolim Regina made our vacation wonderful! Acron Candolim Regina is our favourite destination for staying in Goa. I would recommend this hotel for their hospitality, room service, cleanliness and especially food. I would mention the whole team of Regina Candolim especially Sous-Chef Dipam who took our great care for each meal we had. Amazing art ot pleasing his guests and customers he is an expert in his field and very adjusting to the requirements of his customers. 
                </p>
                <div class="profile mt-auto">
                  <h3>Prateek Sanwal</h3>
                </div>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  Awesome Stay with good food and Service. It was an awesome stay at Acron Candolim Regina.Room was cleaned. Food was delicious and lots of options on Veg and nonveg in the Buffet . Even there are lots of option for Breakfast.The room service and staff was cooperative.As it's my third visit in this hotel and i would definitely like to stay here in my next trip to goa as well. All the best team Acron and keep it up.
                </p>
                <div class="profile mt-auto">
                  <h3>Jenifer</h3>
                </div>
  ...
  <div class="footer-top">
    <div class="container">
      ...
      <ul>
        ...
        <li>Valid till 31st July 2024.</li>
      ...
      <small>
        <ul>
          <li>Non-Cancellable and Non-Refundable and Non-Amendable as a part of Special discounted Offer.</li>
        </ul>
      </small>
    </div>
  </div>
