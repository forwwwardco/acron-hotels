...
header("location: https://acronhotelsgoa.com/campaigns/summer-offer-2023/index.php?type=".$type);
exit();
...
$SOURCE_ARR = array("0"=>"New Year Offer 2023", "HTML"=>"Mailer | New Year Offer 2023", "tripadvisor"=>"Tripadvisor | New Year Offer 2023", "website"=>"Website | New Year Offer 2023", "website_widget"=>"Website Widget | New Year Offer 2023", "SMS"=>"SMS | New Year Offer 2023", "facebook_comment"=>"Facebook Comment | New Year Offer 2023", "facebook_ads"=>"Facebook Ads | New Year Offer 2023", "facebook_post"=>"Facebook Post | New Year Offer 2023", "instagram"=>"Instagram | New Year Offer 2023", "youtube"=>"Youtube | New Year Offer 2023", "facebook_ads_acr_interest"=>"(ACR) FB-Interest | New Year Offer 2023", "facebook_ads_awr_interest"=>"(AWR) FB-Interest | New Year Offer 2023", "facebook_ads_awr_demographic"=>"(AWR) FB-Demographic | New Year Offer 2023", "facebook_ads_acr_demographic"=>"(ACR) FB-Demographic | New Year Offer 2023", "awr_website_widget"=>"AWR Website Widget | New Year Offer 2023", "asr_website_widget"=>"ASR Website Widget | New Year Offer 2023", "acr_website_widget"=>"ACR Website Widget | New Year Offer 2023", "acr_website"=>"ACR Website | New Year Offer 2023", "facebook_ads_awr_lookalike"=>"(AWR) FB-Lookalike | New Year Offer 2023", "facebook_ads_acr_lookalike"=>"(ACR) FB-Lookalike | New Year Offer 2023", "facebook_stage_2"=>"Facebook Lead Ads - (Stage 2)", "whatsapp"=>"Gupshup WhatsApp | New Year Offer 2023", "awr_website"=>"AWR Website | New Year Offer 2023", "asr_website"=>"ASR Website | New Year Offer 2023", "linkedin"=>"Linkedin | New Year Offer 2023", "fb_stage_2_interest"=>"Facebook Lead Ads - (Stage 2)", "facebook_ads_asr_interest"=>"(ASR) FB-Interest | New Year Offer 2023", "google_display_awr"=>"GDN(AWR) | New Year Offer 2023", "google_display_acr"=>"GDN(ACR) | New Year Offer 2023", "google_display_max_awr"=>"HOTELS - AWR | GDN Performance Max", "google_video_acr"=>"Google Video Campaign | ACR", "google_video_awr"=>"Google Video Campaign | AWR", "google_discovery_asr"=>"Google Discovery Campaign(ASR) | New Year Offer 2023", "google_discovery_acr"=>"Google Discovery Campaign(ACR) | New Year Offer 2023", "google_discovery_awr"=>"Google Discovery Campaign(AWR) | New Year Offer 2023");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link rel="canonical" href="https://acronhotelsgoa.com/campaigns/new-year-offer-2023/index.php" />
  <meta property="og:title" content="New Year New Offer! At Acron Group of Hotels" />
  ...
  <meta property="og:image" content="https://acronhotelsgoa.com/campaigns/new-year-offer-2023/assets/images/facebook.jpg" />
  <!-- Bootastrap CSS -->
...
<body>
  ...
  <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
    ...
    <nav id="navbar" class="navbar">
      <ul>
        ...
        <li><a class="nav-link scrollto" href="#features">New Year Offer</a></li>
        ...
        <li><a class="btn btn-lg btn-info" href="tel:+918888848038"><span class="fa fa-phone-alt"></span>&nbsp;Call Now!</a></li>
      </ul>
      ...
      <div class="row d-flex justify-content-between mt-2">
        ...
        <div class="col-lg-7 d-flex align-items-center hero-img" data-aos="zoom-out" data-aos-delay="200">
          <div class="ratio ratio-16x9">
        		<iframe id="videoplay" class="embed-responsive-item" src="https://www.youtube.com/embed/G7u8wCmsW4Y?rel=0&amp;controls=1&amp;showinfo=0&autoplay=1&cc_load_policy=1"></iframe>
      		</div>
        </div>
      </div>
    </div>
  ...
  <main id="main">
    ...
    <!-- ======= About Section ======= -->
    <section id="features" class="features px-1" style="background-color: #FFF7B2;">
            ...
            <div class="content text-center">
              <div class="row">
                <div class="col-lg-4 p-2">
                  <img src="assets/images/acron-waterfront-resort-new-year-offer.jpg" alt="Acron Waterfront Resort New Year Offer" class="img-fluid">
                </div>
                <div class="col-lg-4 p-2">
                  <img src="assets/images/acron-candolim-regina-new-year-offer.jpg" alt="Acron Candolim Regina New Year Offer" class="img-fluid">
                </div>
                <div class="col-lg-4 p-2">
                  <img src="assets/images/acron-seaway-resort-new-year-offer.jpg" alt="Acron Seaway Resort New Year Offer" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0 d-flex justify-content-center text-center">
          ...
          <div class="col-lg-2" data-aos="fade-up" data-aos-delay="200">
            <img class="mb-2" src="assets/images/breakfast.webp" height="100px" class="lazyload">
            <h5>Buffet <br>Breakfast</h5>
          </div>

          <div class="col-lg-2" data-aos="fade-up" data-aos-delay="200">
            <img class="mb-2" src="assets/images/dinner.webp" height="100px" class="lazyload">
            <h5>Dinner on<br>Arrival</h5>
          </div>

          <div class="col-lg-2" data-aos="fade-up" data-aos-delay="200">
            <img class="mb-2" src="assets/images/spa.webp" height="100px" class="lazyload">
            <h5>₹500 Worth <br>Spa Voucher</h5>
          </div>

          <div class="col-lg-2" data-aos="fade-up" data-aos-delay="200">
            <img class="mb-2" src="assets/images/high-tea.webp" height="100px" class="lazyload">
            <h5>High <br>Tea</h5>
          </div>

          <div class="col-lg-2" data-aos="fade-up" data-aos-delay="200">
            <img class="mb-2" src="assets/images/happy-hour.webp" height="100px" class="lazyload">
            <h5>Happy <br>Hour</h5>
          </div>
    ...
    <!-- ======= About Section ======= -->
    <section id="about" class="about" style="background-color: #7D5903; padding: 10px 0;">
...
<footer id="footer" class="footer">
  ...
  <div class="footer-top">
    <div class="container">
      ...
      <small>
      <ul>
        <li>Valid till 31st March 2023.</li>
