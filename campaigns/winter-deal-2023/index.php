...
$SOURCE_ARR = array(""=>"November Offer 2025", "0"=>"November Offer 2025", "HTML"=>"HTML | November Offer 2025", "tripadvisor"=>"Tripadvisor | November Offer 2025", "website"=>"Website | November Offer 2025", "website_widget"=>"Website Widget | November Offer 2025", "SMS"=>"SMS | November Offer 2025", "facebook_comment"=>"Facebook Comment | November Offer 2025", "facebook_ads"=>"Facebook Ads | November Offer 2025", "facebook_post"=>"Facebook Post | November Offer 2025", "instagram"=>"Instagram | November Offer 2025", "youtube"=>"Youtube | November Offer 2025", "awr_website_widget"=>"AWR Website Widget | November Offer 2025", "asr_website_widget"=>"ASR Website Widget | November Offer 2025", "acr_website_widget"=>"ACR Website Widget | November Offer 2025", "acr_website"=>"ACR Website | November Offer 2025", "facebook_ads_awr_lookalike"=>"(AWR) FB-Lookalike | November Offer 2025", "facebook_ads_acr_lookalike"=>"(ACR) FB-Lookalike | November Offer 2025", "facebook_stage_2"=>"Facebook Lookalike (Stage 2) | November Offer 2025", "whatsapp"=>"Gupshup WhatsApp | November Offer 2025", "awr_website"=>"AWR Website | November Offer 2025", "asr_website"=>"ASR Website | November Offer 2025", "linkedin"=>"Linkedin | November Offer 2025", "google_display_acr"=>"GDN(ACR) | November Offer 2025", "google_video_acr"=>"Google Video Campaign | ACR", "google_video_awr"=>"Google Video Campaign | AWR", "demand_gen_awr"=>"Google Demand Gen(AWR) | November Offer 2025", "demand_gen_asr"=>"Google Demand Gen(ASR) | November Offer 2025", "demand_gen_acr"=>"Google Demand Gen(ACR) | November Offer 2025", "google_pmax"=>"Google Performance Max | November Offer 2025");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Beach Hotel Offer in Goa | Acron Goa Hotels Packages | Book Directly With Us</title>
  <META NAME="title" CONTENT="Beach Hotel Offer in Goa | Acron Goa Hotels Packages | Book Directly With Us" />
  <meta name="description" content="Get unbeatable deals on your stay, exclusive upgrades and lowest price guaranteed only when you book directly with us" />
  <meta name="keywords" content="boutique hotels in Goa, hotels near baga beach, hotels near candoim beach,luxury resort in baga, luxury holiday villas in goa, exclusive Beach resorts in Baga Goa, waterfront resorts in goa, baga, candolim, goa" />
  <META NAME="author" CONTENT="Acron Group of Hotels" />
  <META NAME="copyright" CONTENT="Acron Hospitality Pvt. Ltd." />
  <META NAME="robots" CONTENT="all" />
  <link rel="canonical" href="https://acronhotelsgoa.com/campaigns/packages-2026/index.php" />
  <meta property="og:title" content="Where winter meets Goa's magic at Acron Group of Hotels" />
...
<body>
  ...
  <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
    ...
    <nav id="navbar" class="navbar">
      <ul>
        ...
        <li><a class="nav-link scrollto" href="#portfolio">Photo Gallery</a></li>
      ...
      <div class="row d-flex justify-content-between mt-4">
        ...
        <div class="col-lg-8 d-flex align-items-center hero-img" data-aos="zoom-out" data-aos-delay="200">
          <div class="ratio ratio-16x9">
            <iframe id="videoplay" class="embed-responsive-item" src="https://www.youtube.com/embed/hR4be6mqJc0?rel=0&amp;controls=1&amp;showinfo=0&autoplay=1&cc_load_policy=1"></iframe>
            <!-- <lite-youtube videoid="3aP_Lv4Bg7s" style="background-image: url('https://i.ytimg.com/vi/3aP_Lv4Bg7s/maxresdefault.jpg');">
  ...
  <main id="main">
    ...
    <!-- ======= About Section ======= -->
    <section id="features" class="features px-1" style="background-color: #FAF0E6;">

      <header class="section-header">
        <p>Let's GOA on a holiday</p>
            ...
            <div class="content text-center">
              <div class="row">
                <div class="col-lg-4 p-2">
                  <img src="assets/images/acron-waterfront-resort-winter-offer.webp" alt="Acron Waterfront Resort winter Offer" class="img-fluid">
                </div>
                <div class="col-lg-4 p-2">
                  <img src="assets/images/acron-candolim-regina-winter-offer.webp" alt="Acron Candolim Regina winter Offer" class="img-fluid">
                </div>
                <div class="col-lg-4 p-2">
                  <img src="assets/images/acron-seaway-resort-winter-offer.webp" alt="Acron Seaway Resort winter Offer" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
    ...
    <section id="book-direct-advantages" class="about px-1">
      ...
      <div class="container" data-aos="fade-up">
        <div class="row p-4 gx-0 d-flex justify-content-center text-center" style="color: #0C7A7A;">

          <div class="col-lg-2 p-4">
            <img src="assets/images/icons/buffet-breakfast.jpg" width="150px" alt="Buffet Breakfast" class="img-fluid">
            <h4><b>Buffet Breakfast</b></h4>
          </div>
          <div class="col-lg-2 p-4">
            <img src="assets/images/icons/buffet-dinner.jpg" width="150px" alt="Dinner" class="img-fluid">
            <h4><b>Dinner</b></h4>
          </div>
          <div class="col-lg-2 p-4">
            <img src="assets/images/icons/happy-hour.jpg" width="150px" alt="Happy Hour" class="img-fluid">
            <h4><b>Happy Hour</b></h4>
          </div>
          <!--          
          <div class="col-lg-2 p-4">
            <img src="assets/images/icons/spa.jpg" width="150px" alt="Head & Foot Massage" class="img-fluid">
            <h4><b>500 Worth Spa Discount Voucher</b></h4>
          </div> -->
          <div class="col-lg-2 p-4">
            <img src="assets/images/icons/high-tea.jpg" width="150px" alt="High Tea" class="img-fluid">
            <h4><b>High Tea</b></h4>
          </div>
          <div class="col-lg-2 p-4">
            <img src="assets/images/icons/discount.jpg" width="150px" alt="15% off on Food & Drinks" class="img-fluid">
            <h4><b>On Food, Drinks & Spa</b></h4>
          </div>
    ...
    <!-- ======= About Section ======= -->
    <section id="about" class="about" style="background-color: #0C7A7A; padding: 10px 0;">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile mt-auto">
                  <h3>Parth Shah</h3>
                  <small>Acron Waterfront Resort</small>
                </div>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>Prime location and comforting. The experience of staying here was great, even I decided to stay here for one day only but the atmosphere was overwhelming so I decided to extend my stay. The staff was very cooperative and I recommend everyone to stay here. The acron group of hotels are superb.</p>
                <div class="profile mt-auto">
                  <h3>Anshika</h3>
                  <small>Acron Seaway Resort</small>
                </div>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>The best place to stay in North Goa with a lovely pool facing river. Acron waterfront is a beautiful property with pool, river and sea view rooms. I've been staying at Acron for almost a decade and this place has never disappointed and is maintained as good as it was when it was launched. The property is located extremely close to Baga and yet away nestled in a quiet location among scenic views.</p>
                <div class="profile mt-auto">
                  <h3>Anu S</h3>
                  <small>Acron Waterfront Resort</small>
                </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>Very nice resort for family and couple. One of the best resort to stay for with family. Staff is very good and friendly.
                Provided me with special Jain food on request. Breakfast and dinner buffet was delicious and superb. Location is also very good, it's walking distance to Baga.
                </p>
                <div class="profile mt-auto">
                  <h3>Anshul</h3>
                  <small>Acron Waterfront Resort</small>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>Absolutely Delightful Family Stay at Acron Candolim Regina! We had an amazing experience during our stay at Acron Candolim Regina. The entire staff was courteous, polite, and always ready to help. Truly impressed with the level of service and hospitality. Highly recommend this property to anyone travelling with family — you won’t be disappointed!</p>
                <div class="profile mt-auto">
                  <h3>Ravi</h3>
                  <small>Acron Candolim Regina</small>
                </div>
              </div>
            </div><!-- End testimonial item -->
        ...
        <div class="row g-4 p-2">
          ...
          <div class="col-lg-12 p-0" data-aos="fade-up" data-aos-delay="200" style="box-shadow: 0px 0 30px rgb(1 41 112 / 8%);">
            <div class="row">
              ...
              <div class="col-lg-8 p-4 hotel-bg">
  ...
  <div class="footer-top">
    <div class="container">
      ...
      <ul>
        ...
        <li>Valid from 1st June to 30th September 2025.</li>
...
<a href="#" class="back-to-top d-flex align-items-center justify-content-center"><i class="fas fa-arrow-up"></i></a>
  ...
  <!--LS Chatbot Script-->
  <!-- <iframe style="bottom: 15px; right: 10px;" id="lsq-chatbot" src="https://sgp-botweb.converse.leadsquared.com/?botId=115&tenantId=3502&type=WEB&channelId=585e1361-6fb5-4255-b613-9898cd6a9a29"></iframe> -->
