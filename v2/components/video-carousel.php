...
$activeTheme = $themeConfig[$pageResort] ?? 'yt-embed-home';
          ...
          <div class="carousel-inner rounded-4 shadow-sm">
            <?php foreach ($videos as $index => $videoUrl): ?>
              <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>">
                <div class="ratio ratio-16x9"><iframe src="<?php echo $videoUrl; ?>" title="YouTube video" allowfullscreen></iframe></div>
              </div>
            <?php endforeach; ?>
          </div>
          <div class="d-flex align-items-center justify-content-center gap-4 mt-4">
            <button class="custom-video-control" type="button" data-bs-target="#<?php echo $carouselId; ?>" data-bs-slide="prev"><i class="fa-solid fa-chevron-left"></i></button>
            ...
            <button class="custom-video-control" type="button" data-bs-target="#<?php echo $carouselId; ?>" data-bs-slide="next"><i class="fa-solid fa-chevron-right"></i></button>
          </div>
        </div>
      </div>
    </div>
