...
$themeContext = !empty($pageResort) ? 'nav-' . $pageResort : 'nav-home';
...
?>
<header class="acron-header shadow-sm fixed-top <?= htmlspecialchars($themeContext) ?>">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="acronOffcanvas" aria-labelledby="acronOffcanvasLabel" data-bs-backdrop="false">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-lg-4 text-uppercase fw-semibold" id="mainNavLinks">
                        <li class="nav-item"><a class="nav-link" href="<?= htmlspecialchars($home) ?>">Home</a></li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu border-0 shadow-sm desktop-dropdown-menu" aria-labelledby="hotelsDropdown">
                                <li><a class="dropdown-item fw-semibold text-uppercase" href="<?= htmlspecialchars($waterfront) ?>">Acron Waterfront Resort</a></li>
                                <li><a class="dropdown-item fw-semibold text-uppercase" href="<?= htmlspecialchars($regina) ?>">Acron Candolim Regina</a></li>
                                <li><a class="dropdown-item fw-semibold text-uppercase" href="<?= htmlspecialchars($seaway) ?>">Acron Seaway Resort</a></li>
                            </ul>
                            ...
                            <div class="collapse show d-lg-none" id="mobileHotelsMenu">
                                <ul class="navbar-nav ps-4">
                                    <li class="nav-item"><a class="nav-link" href="<?= htmlspecialchars($waterfront) ?>">Acron Waterfront Resort</a></li>
                                    <li class="nav-item"><a class="nav-link" href="<?= htmlspecialchars($regina) ?>">Acron Candolim Regina</a></li>
                                    <li class="nav-item"><a class="nav-link" href="<?= htmlspecialchars($seaway) ?>">Acron Seaway Resort</a></li>
                                </ul>
                            </div>
                        </li>
                            ...
                            <ul class="dropdown-menu border-0 desktop-tooltip-menu p-3" aria-labelledby="whyBookDropdown">
                                <?php foreach ($direct_booking_benefits as $index => $benefit): ?>
                                    ...
                                    <li class="<?= $is_last ? 'mb-0' : 'mb-2' ?>">
                                        <i class="fa-solid fa-check text-yellow me-2" aria-hidden="true"></i> <?= htmlspecialchars($benefit) ?>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        ...
                        <li class="nav-item"><a class="nav-link" href="<?= htmlspecialchars($contact) ?>">Contact Us</a></li>
                    </ul>
            ...
            <div class="modal-body text-center py-4">
                ...
                <div class="modal-contacts d-flex flex-column gap-3">
                    <div class="d-flex align-items-center justify-content-center gap-2">
                        <a href="tel:+91XXXXXXXXXX" aria-label="Call +91 XXXXX XXXXX" class="text-decoration-none text-blue-grey"><i class="fa-solid fa-phone" aria-hidden="true"></i></a>
                        <span class="opacity-50 fw-light" aria-hidden="true">/</span>
                        <a href="https://wa.me/91XXXXXXXXXX" target="_blank" aria-label="WhatsApp +91 XXXXX XXXXX" class="text-decoration-none text-blue-grey wa-link"><i class="fa-brands fa-whatsapp" aria-hidden="true"></i></a>
