        ...
        <div class="row align-items-center gy-5">
            ...
            <div class="col-lg-5">
                <div id="<?= $crossPromoData['id'] ?>" class="carousel slide rounded-4 shadow overflow-hidden position-relative" data-bs-ride="carousel" data-bs-interval="5000" data-bs-pause="hover">
                    ...
                    <div class="carousel-inner">
                        <?php foreach ($crossPromoData['images'] as $index => $imgUrl): ?>
                            <div class="carousel-item <?= $index === 0 ? 'active' : '' ?>">
                                <img src="<?= $imgUrl ?>" class="d-block w-100 promo-carousel-img" alt="<?= $crossPromoData['heading'] ?> - Image <?= $index + 1 ?>">
                            </div>
                        <?php endforeach; ?>
                    </div>
                    ...
                    <div class="promo-controls-wrapper d-flex align-items-center justify-content-center gap-3">
                        <button class="promo-control-btn" type="button" data-bs-target="#<?= $crossPromoData['id'] ?>" data-bs-slide="prev">
                        ...
                        <div class="carousel-indicators promo-indicators position-static m-0">
                            <?php foreach ($crossPromoData['images'] as $index => $imgUrl): ?>
                                <button type="button"
                                    data-bs-target="#<?= $crossPromoData['id'] ?>"
                        ...
                        <button class="promo-control-btn" type="button" data-bs-target="#<?= $crossPromoData['id'] ?>" data-bs-slide="next">
            ...
            <div class="col-lg-6 offset-lg-0 text-center text-lg-start">
                <p class="promo-tagline fw-bold text-uppercase mb-2 text-blue-grey opacity-75">
                    <?= $crossPromoData['tagline'] ?>
                </p>
                <h2 class="promo-heading fw-bold text-blue-grey mb-4">
                    <?= $crossPromoData['heading'] ?>
                </h2>
                <p class="promo-text text-blue-grey opacity-75 mb-0">
                    <?= $crossPromoData['description'] ?>
                </p>
            </div>
