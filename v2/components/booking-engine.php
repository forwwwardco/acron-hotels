...
// Map context keys to STAAH property IDs
$staahIds = [
    'waterfront' => 'MzAw',
    'regina'     => 'Mjk4',
    'seaway'     => 'NzQy'
...
// Determine CSS classes for contextual theming
...
<section class="booking-engine-fixed w-100 <?= $esc_html($engineContext) ?>" id="bookingEngine" aria-label="Hotel Booking Engine">
    ...
    <button type="button" class="engine-toggle-btn d-lg-none" id="engineToggle" aria-expanded="false" aria-controls="book-direct-form">
    ...
    <div class="booking-panel container-fluid px-lg-5">
        <form class="booking-form py-3 py-lg-4" id="book-direct-form" target="_blank" aria-label="Book Direct Form">
            <div class="row align-items-end g-3 g-lg-4">
                ...
                <div class="col-12 col-lg-3">
                    <button type="submit" class="btn btn-book-now <?= $esc_html($btnClass) ?> w-100 fw-bold py-2 py-lg-3">
                        BOOK NOW
                    </button>
                </div>
