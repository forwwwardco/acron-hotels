    ...
    <div class="container py-4">
        <div class="row align-items-center gy-5">
            ...
            <div class="col-lg-6 reveal">
                <figure class="m-0">
                    <img src="<?= $esc_html($imgHeadBtnComponentData['image']) ?>" class="img-fluid w-100 rounded-4 shadow-sm legacy-img" alt="<?= $esc_html($imgHeadBtnComponentData['heading']) ?>" loading="lazy">
                </figure>
            </div>
            ...
            <div class="col-lg-6 px-lg-5 text-center text-lg-start reveal">
                <header>
                    <p class="legacy-tagline text-uppercase fw-bold text-blue-grey opacity-75 mb-3">
                        <?= $esc_html($imgHeadBtnComponentData['tagline']) ?>
                    </p>
