    ...
    <div class="modal-dialog modal-dialog-centered modal-lg px-4">
        <div class="modal-content border-0 shadow-lg special-offers-card">
            ...
            <div class="modal-body text-center pt-3 pb-4">
                <img src="https://placehold.co/800x800/e3f6f5/2d334a?text=Custom+Goa+Map" alt="Illustrated Map of Goa" class="img-fluid rounded-4 shadow-sm mb-4 w-100 object-fit-cover" style="max-height: 50vh;">
