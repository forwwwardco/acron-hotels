 ...
 */
$url = $customMapImg ?? "v2/assets/acron-map.webp";
?>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg px-4">
        <div class="modal-content border-0 shadow-lg special-offers-card">
            ...
            <div class="modal-body text-center pt-3 pb-4">
                ...
                <a href="#" id="dynamicGoogleMapsBtn" target="_blank" rel="noopener noreferrer" class="btn btn-yellow fw-bold px-4 py-3 w-100 w-md-auto d-inline-flex align-items-center justify-content-center gap-2 shadow-sm"><i class="fa-solid fa-map-location-dot" aria-hidden="true"></i> VIEW ON GOOGLE MAPS</a>
            </div>
        </div>
    </div>
</div>