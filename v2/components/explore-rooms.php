        ...
        ?>
            ...
            <div class="row align-items-center gy-4 gy-lg-5 mb-5 mb-lg-5 pb-3 room-row reveal">
                ...
                <div class="col-lg-6 <?= $textOrder ?>">
                    ...
                    <p class="text-blue-grey opacity-75 mb-4 small fw-medium lh-lg <?= $isAlt ? '' : 'pe-lg-4' ?>"><?= $room['description'] ?></p>
                    ...
                    <div class="room-image-composition position-relative <?= $imgWrapperPadding ?>">
                        <div id="<?= $room['id'] ?>Carousel" class="carousel slide room-carousel position-relative" data-bs-ride="carousel" data-bs-interval="5000" data-bs-pause="hover">
                            ...
                            <div class="room-controls-wrapper d-flex align-items-center justify-content-center gap-4 position-absolute w-100 pb-3 z-3" style="bottom: 0;">
                                <button class="promo-control-btn border-0 bg-transparent d-flex align-items-center" type="button" data-bs-target="#<?= $room['id'] ?>Carousel" data-bs-slide="prev"><i class="fa-solid fa-chevron-left"></i></button>
                                ...
                                <button class="promo-control-btn border-0 bg-transparent d-flex align-items-center" type="button" data-bs-target="#<?= $room['id'] ?>Carousel" data-bs-slide="next"><i class="fa-solid fa-chevron-right"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
