...
<section class="image-head-body-section pt-5 position-relative reveal" aria-labelledby="image-head-body-Heading">
    <img src="v2/assets/palm.webp" class="decor decor-t0-r0" alt="" aria-hidden="true" loading="lazy">
    <div class="container pb-5 mb-lg-4">
        <div class="row align-items-center gy-5">
            ...
            <div class="col-lg-6 text-center px-lg-5 text-lg-start">
                <header>
                    <p class="promo-tagline fw-bold text-uppercase mb-2 text-blue-grey opacity-75"><?= $esc_html($imgHeadBodyComponentData['tagline']) ?></p>
                    <h2 id="image-head-body-Heading" class="promo-heading fw-bold text-blue-grey mb-4"><?= $esc_html($imgHeadBodyComponentData['heading']) ?></h2>
                </header>
                <p class="promo-text text-blue-grey opacity-75 mb-0"><?= nl2br($esc_html($imgHeadBodyComponentData['description'])) ?></p>
            </div>
        </div>
    </div>
