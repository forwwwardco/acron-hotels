...
$themeConfig = [
    'waterfront' => ['context'   => 'enquiry-form-waterfront'],
    'regina' => ['context'   => 'enquiry-form-regina'],
    'seaway' => ['context'   => 'enquiry-form-seaway']
];
$activeTheme = $themeConfig[$pageResort] ?? ['context'   => 'enquiry-form-home'];
?>
<aside class="enquiry-panel-wrapper" id="enquiryPanel">
    <button class="enquiry-trigger" id="enquiryTrigger"><span class="btn-text">ENQUIRE</span></button>
    <div class="enquiry-content <?php echo $activeTheme['context']; ?> py-4 px-4">
        <form id="enquiryForm" action="process-enquiry.php" method="POST">
            <div class="mb-3"><input type="text" name="name" class="form-control enquiry-input" placeholder="Name *" required></div>
            <div class="mb-3"><input type="tel" name="phone" class="form-control enquiry-input" placeholder="Phone Number *" required></div>
            <div class="mb-3"><input type="email" name="email" class="form-control enquiry-input" placeholder="Email"></div>
            <div class="mb-3">
            ...
            <div class="mb-3"><textarea name="message" class="form-control enquiry-input" rows="2" placeholder="Message"></textarea></div>
