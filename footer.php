      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
          ...
          <div class="social-links mt-2">
            <a href="https://www.youtube.com/@acrongroupofhotels/videos" target="_blank" aria-label="Facebook" class="youtube"><h3 class="fab fa-youtube" style="color: #FF0000;"></h3></a>
